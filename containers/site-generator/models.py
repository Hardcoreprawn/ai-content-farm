...
class SiteInfo(BaseModel):
    ...
    article_count: int = Field(...,
                               description="Number of articles in the site")
...
class ContentItem(BaseModel):
    ...
    source: str = Field(...,
                        description="Content source (reddit, hackernews, etc.)")
...
class SiteMetadata(BaseModel):
    ...
    generation_date: datetime = Field(...,
                                      description="When site was generated")
    ...
    content_sources: List[str] = Field(...,
                                       description="Content sources included")

...
class BlobTemplateLoader(BaseLoader):
    ...
    def __init__(self, blob_client: BlobStorageClient, container_name: str = "site-templates"):
...
def create_template_manager(blob_client: BlobStorageClient, use_local: bool = False) -> TemplateManager:

...
class TestSiteGeneratorAPI:
    ...
    def test_generate_site_endpoint_validation_error(self, test_client):
        ...
        response = test_client.post("/api/sites/generate", json=invalid_request)
    ...
    def test_error_handling_in_api(self, test_client):
        ...
        for case in test_cases:
            response = test_client.post("/api/sites/generate", json=case["data"])
            assert (
    ...
    def test_theme_validation(self, test_client):
        ...
        for theme in valid_themes:
            ...
            response = test_client.post("/api/sites/generate", json=request_data)

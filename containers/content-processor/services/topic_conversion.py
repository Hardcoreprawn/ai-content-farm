"""
Topic Conversion Service

Handles conversion of collection items to TopicMetadata and priority scoring.
Extracted from ContentProcessor to improve maintainability and reduce file size.
"""
...
class TopicConversionService:
    """Service for converting collection items to TopicMetadata."""

...
# Function App access policy removed during container migration
...
# Azure Functions infrastructure removed during container migration
# Service plan, function app, and role assignments replaced with container services
